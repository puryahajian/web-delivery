...
function TempMenuBottomMobile() {
    ...
    return (
        <div className={`fixed bottom-0 right-0 w-full bg-white py-4 hidden max-[480px]:block 
            ...
            `}>
            <div className='grid grid-cols-3 px-6 gap-[60px]'>
                <Link to="/" aria-current={isHome ? 'page' : undefined}>
                    <div className={`text-center ${isHome ? 'text-BgCustom' : 'text-gray-400'}`}>
                        <svg 
                            width="25" 
                            height="25" 
                            className='m-auto'
                ...
                <Link to="/active-order" aria-current={isActiveOrder ? 'page' : undefined}>
                    <div className={`text-center ${isActiveOrder ? 'text-BgCustom' : 'text-gray-400'}`}>
                        <svg 
                            width="25" 
                            className='m-auto'
                            height="25" 
                            ...
                            xmlns="http://www.w3.org/2000/svg">
                                <path 
                                    ...
                                    fill={isActiveOrder ? '#ca4f4f' : '#9ca3af'}
                                />
                        </svg>
                ...
                <Link to="/category-mobile" aria-current={isActiveCategory ? 'page' : undefined}>
                    <div className={`text-center ${isActiveCategory ? 'text-BgCustom' : 'text-gray-400'}`}>
                        <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            width={25} 
                            height={25}
                            ...
                            viewBox="0 0 24 24">
                                <path 
                                    ...
                                    fill={isActiveCategory ? '#ca4f4f' : '#9ca3af'}
                                    >
                                </path>
                        </svg>
