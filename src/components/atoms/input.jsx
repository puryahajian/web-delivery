    ...
    return (
        <div className="relative w-full">
            ...
            <input
                type="text"
                autoComplete="off"
                className={`${className} w-full h-12 border border-BorderGray placeholder:text-[16px] placeholder:text-BorderGray bg-Gray1 rounded-lg pr-14 outline-none max-[480px]:text-base text-[16px]`}
