        ...
        <div className="max-[480px]:mx-[16px]">
            ...
            <ul className='grid gap-[18px] max-[480px]:mt-[70px]'>
                <li className='flex gap-4'>
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="m-auto" width={16} height={16} viewBox="0 0 24 24"><path fill="#356554" d="M12 11.5A2.5 2.5 0 0 1 9.5 9A2.5 2.5 0 0 1 12 6.5A2.5 2.5 0 0 1 14.5 9a2.5 2.5 0 0 1-2.5 2.5M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7"></path></svg>
                    </AvatarButtonHeader>
                    <div>
                        <Text className={`font-bold`}>آدرس</Text>
                        <Text>{getData?.address === "" ? 'موجود نیست' : getData?.address}</Text>
                    </div>
                </li>
                <li className='flex gap-4'>
                    <AvatarButtonHeader
                ...
                <li className='flex gap-4'>
                    <AvatarButtonHeader
                        ...
                        classImg={`hidden`}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24"><path fill="#356554" d="M17.688 21.744a2.02 2.02 0 0 1-1.242-.427l-4.03-3.122l-2.702 2.983a1 1 0 0 1-1.698-.383l-2.02-6.682l-3.626-1.26a2.042 2.042 0 0 1-.103-3.818L20.187 1.8a2.042 2.042 0 0 1 2.771 2.295L19.695 20.11a2.054 2.054 0 0 1-2.008 1.633Z" opacity={0.5}></path><path fill="#356554" d="M8.973 21.506a1 1 0 0 1-.957-.71l-2.168-7.16a1 1 0 0 1 .495-1.176L16.91 6.958a1 1 0 0 1 1.17 1.594l-7.084 7.083l-1.044 5.072a1 1 0 0 1-.933.798z"></path></svg>
                    </AvatarButtonHeader>
                    <div>
                        <Text className={`font-bold`}>تلگرام</Text>
                        <Text>{getData?.telegram === null ? 'موجود نیست' : getData?.telegram}</Text>
                    </div>
                </li>
                    <li className='flex gap-4'>
                    <AvatarButtonHeader
