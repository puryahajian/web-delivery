        ...
        <div>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='mt-[143px]'>
                            <div className='flex mt-8 gap-10'>
                                <div>
                                    <Text>
                                        ارتفاع: {data?.data?.height ? data?.data?.height : 'موجود نیست'}
                                    </Text>
                                </div>
                                <div>
                                    <Text>
                                        عرض: {data?.data?.width ? data?.data?.width : 'موجود نیست'}
                                    </Text>
                                </div>
                                <div>
                                    <Text>
                                        طول: {data?.data?.length ? data?.data?.length : 'موجود نیست'}
                                    </Text>
                                </div>
                                <div>
                                    <Text>
                                        وزن: {data?.data?.weight ? data?.data?.weight : 'موجود نیست'}
                                    </Text>
                                </div>
                            </div>
                            ...
                            <div className='mt-[20px] flex justify-between items-center'>
                                <div className='flex gap-4 items-center'>
                                    <div className="relative">
                                        <Text className="text-lg flex items-center gap-2">{data?.data?.price} تومان</Text>
                                        <span className="absolute left-0 top-1/2 w-full h-[2px] bg-black rotate-[-10deg]"></span>
                                    </div>
                                    <Text className={`text-2xl font-bold text-red-500 flex items-center gap-2`}>{data?.data?.discounted_price} تومان</Text>
                                </div>
            ...
            <div className='mt-[90px] max-[480px]:mb-[100px] hidden max-[480px]:block'>
                ...
                <div className='flex justify-between items-center'>
                    <div className='flex items-center gap-2 py-6'>
                        <div className='border-2 border-BorderCustom bg-BorderCustom w-6 h-2 rounded-lg'/>
                        <Text className={`font-bold`}>قیمت</Text>
                    </div>
                    ...
                    <div className=' gap-4 items-center'>
                        ...
                        <Text className={`text-2xl font-bold text-red-500 flex items-center gap-2 ${!data?.data?.discounted_price && 'hidden'}`}>{data?.data?.discounted_price} تومان</Text>
                    </div>
                </div>
                ...
                <div className='flex items-center gap-2 py-6'>
                    <div className='border-2 border-BorderCustom bg-BorderCustom w-6 h-2 rounded-lg'/>
                    <Text className={`font-bold`}>توضیحات</Text>
                </div>
